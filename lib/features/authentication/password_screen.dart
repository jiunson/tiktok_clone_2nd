...
class _EmailScreenState extends State<PasswordScreen> {
  ...
  String _password = "";
  bool _obscureText = true; // 비밀번호 보기 숨기
  ...
  bool _isPasswordValid() {
    ...
    final regExp = RegExp(
        r"^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$"); // 최소 8자, 하나 이상의 문자와 하나의 숫자
  ...
  void _onClearTap() {
    _passwordController.clear(); // 입력 값을 삭제한다.
  }
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Gaps.h5,
                  const Text("8 characters or more")
                ],
              ),
              Gaps.v10,
              Row(
                children: [
                  ...
                  Gaps.h5,
                  const Text("Includes letters and numbers")
                ],
              ),
              Gaps.v28,
              GestureDetector(
